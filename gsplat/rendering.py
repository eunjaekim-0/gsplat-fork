...
def rasterization(
    ...
    if packed:
        ...
        # Radii not returned by projection (testing); use zero tensor same shape as means2d.
        means2d, depths, conics, compensations = proj_results
        radii = torch.zeros_like(means2d, dtype=torch.int32)
